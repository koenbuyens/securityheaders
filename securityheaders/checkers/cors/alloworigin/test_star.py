...
from securityheaders.checkers.cors import AccessControlAllowOriginStarChecker

class AccessControlAllowOriginStarCheckerTest(unittest.TestCase):
    def setUp(self):
       self.x = AccessControlAllowOriginStarChecker()
    ...
    def test_checkInvalid(self):
       hasx2 = dict()
       hasx2['access-control-allow-origin'] = "*"
